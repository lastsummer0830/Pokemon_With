...
description: 집 꾸미기 → 포켓몬 컨디션 → 배틀 보너스 연결(이 게임의 차별점)을 만드는 스킬. house·furniture·decoration, condition, homeBonus, battle bonus, HouseScene. 트리거 예: "집 꾸미기 붙여줘", "가구 효과 만들어", "컨디션 올리기", "집이랑 배틀 연결해줘".
---
