...
description: 저장·불러오기(세이브) 기능을 만드는 스킬. save·load, localStorage, player progress, party·houseLayout, 세이브 버전 migration. 트리거 예: "저장 기능 만들어", "이어하기 되게 해줘", "세이브 깨졌어", "불러오기 안 돼".
---
