...
WHITELIST = [
    ...
    "ORANBERRY", "TM09",
    # 상록시티 민가 4채(AR Map160~163)가 주는 것 (2026-08-04).
    #  · 원예사(Map160)가 넷 중 하나를 고르게 하는 물뿌리개 — 원본 그대로 4종 다 있어야 선택지가 성립한다.
    #  · 포켓인형(Map161) = 아이 침대 옆 볼. 가져가면 아이가 운다.
    "SQUIRTBOTTLE", "SPRAYDUCK", "WAILMERPAIL", "SPRINKLOTAD", "POKEDOLL",
]
